...
export const loginController = async function (req: express.Request, res: express.Response) {
...
export const registerController = async function (req: express.Request, res: express.Response, next: express.NextFunction) {
