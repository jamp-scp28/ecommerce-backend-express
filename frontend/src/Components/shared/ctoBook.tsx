            ...
            <div className="container items-center max-w-6xl px-8 mx-auto xl:px-5">
                ...
                <div className="w-full md:w-1/2 md:px-3">
                    ...
                    <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl">
                        <span className="block xl:inline">Todo listo?</span>
                        <span className="block text-indigo-600 xl:inline"> agenda tu servicio aquí!</span>
                    </h1>
                    <p className="mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl"></p>
                    <div className="relative flex flex-col sm:flex-row sm:space-x-4">
                        <a href="#_" className="flex items-center w-full px-6 py-3 mb-3 text-lg text-white bg-blue rounded-md sm:mb-0 hover:bg-indigo-700 sm:w-auto">
                            Vamos allá
...
export default CallToActionBookNow;